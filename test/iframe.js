...
describe('Есть iframe на странице.', function() {
    before(function() {
        document.getElementsByClassName('wrapper')[0].innerHTML = originalHTML
    })

    it('Инициализируется без ошибок на странице где есть iframe', function() {
        var x = baron({
