...
c=F,f.h&&(c=G),y=f.fixRadius||0,console.log("fixRadius",y),g(e[c.client]<e[c.scrollSize]),C(1),A=f.hFixCls,d(e,"scroll",z,"on"),d(h,"mousewheel",function(b){try{a=document.createEvent("WheelEvent"),a.initWebKitWheelEvent(b.originalEvent.wheelDeltaX,b.originalEvent.wheelDeltaY),e.dispatchEvent(a),b.preventDefault()}catch(c){}}),d(window,"resize",t),d(b,"heightChange",t),d(l,"mousedown",function(a){a.preventDefault();p();B=1}),d(document,"mouseup blur",function(){p(1);B=0}),d(document,"mousedown",function(a){E=
a.clientY-D}),d(document,"mousemove",function(a){B&&(e.scrollTop=(a.clientY-E)/(w[c.client]-l[c.offset])*(e[c.scrollSize]-e[c.client]))}),z(),this};p.init.prototype.update=function(){this.viewport(1);this.updateScrollBar()};if(j=g.selector||n)if(d=g.event||function(b,f,d,g){n(b)[g||"on"](f,d)},g.event||n)if(k=g.dom||n){b[0]||(b=[b]);for(var t=0;t<b.length;t++)b[t].getAttribute("data-baron")?d(b[t],"heightChange",u,"trigger"):this[t]=new p.init(b[t],g);return this}};x.prototype.u=function(){for(var b=
-1;this[++b];)this[b].update()};n&&n.fn&&(n.fn.baron=p);window.baron=p})(window.jQuery);